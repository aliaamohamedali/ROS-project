...
python ~/workspaces/grad_project_catkin_workspace/src/yolo_classify/scripts/yolo_classify.py &
python ~/workspaces/grad_project_catkin_workspace/src/App-Server/Server.py &
python ~/workspaces/grad_project_catkin_workspace/src/goto/src/goto.py
